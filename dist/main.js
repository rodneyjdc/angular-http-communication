...
let AddReaderComponent = class AddReaderComponent {
    ...
    saveReader(formValues) {
        ...
        this.dataService.addReader(newReader)
            .subscribe((data) => console.log('After POST request', data), (err) => console.log(err));
    }
};
...
let CacheInterceptor = class CacheInterceptor {
    ...
    intercept(req, next) {
        ...
        let cachedResponse = this.cacheService.get(req.url);
...
/* harmony import */ var _cache_interceptor__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./cache.interceptor */ 7354);
...
let DataService = class DataService {
    ...
    getReaderById(id) {
        ...
        const getHeaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__.HttpHeaders({
    ...
    addReader(newReader) {
        const postHeaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__.HttpHeaders({
    ...
    updatedReader(updatedReader) {
        const putHeaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__.HttpHeaders({
            'Content-Type': 'application/json'
        });
    ...
    getAllBooks() {
        ...
        let myContext = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__.HttpContext();
        myContext.set(_add_header_interceptor__WEBPACK_IMPORTED_MODULE_2__.CONTENT_TYPE, 'application/xml');
        myContext.set(_cache_interceptor__WEBPACK_IMPORTED_MODULE_3__.CACHEABLE, false);
        return this.http.get('api/books', {
            context: myContext
        })
            .pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.catchError)(err => this.handleHttpError(err)));
    }
    getBookById(id) {
    ...
    getOldBookById(id) {
        return this.http.get(`api/books/${id}`)
            .pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.map)(book => ({
    ...
    handleHttpError(error) {
        ...
        return (0,rxjs__WEBPACK_IMPORTED_MODULE_8__.throwError)(dataError);
    }
};
DataService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_4__.HttpClient }
];
DataService = (0,tslib__WEBPACK_IMPORTED_MODULE_9__.__decorate)([
...
let DashboardComponent = class DashboardComponent {
    ...
    ngOnInit() {
        ...
        }, (err) => console.log(err), () => console.log('All done getting readers'));
...
let EditBookComponent = class EditBookComponent {
    ...
    ngOnInit() {
        ...
        this.dataService.getOldBookById(bookID)
            .subscribe((data) => console.log(`Old book title is ${data.bookTitle}`));
    }
    setMostPopular() {
    ...
    saveChanges() {
        this.dataService.updateBook(this.selectedBook)
            .subscribe((data) => console.log(`${this.selectedBook.title} successfully updated`), (err) => console.log(err));
    }
};
...
let EditReaderComponent = class EditReaderComponent {
    ...
    saveChanges() {
        this.dataService.updatedReader(this.selectedReader)
            .subscribe((data) => console.log(`Reader ${this.selectedReader.name} successfully updated.`), (err) => console.log(err));
    }
};
